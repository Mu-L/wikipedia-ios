...
private extension WMFReadingChallengeWidgetViewModel.DisplaySet {
    ...
    static func streakSet(streak: Int) -> WMFReadingChallengeWidgetViewModel.DisplaySet {
        ...
        let defaultSet = WMFReadingChallengeWidgetViewModel.DisplaySet(
            ...
            image: "phoneGlobe",
            title: String.localizedStringWithFormat(title, streak),
            subtitle: subtitle,
            icon: icon
        )
    ...
    static func streakNotYetReadSet(streak: Int, showButtons: Bool, colorSet: WMFTheme.ReadingChallengeColorSet = .orange) -> WMFReadingChallengeWidgetViewModel.DisplaySet {
        ...
        return WMFReadingChallengeWidgetViewModel.DisplaySet(
            ...
            button2Title: showButtons ? CommonStrings.randomButton : nil,
    ...
    static func incompleteSet(family: WidgetFamily, streak: Int) -> WMFReadingChallengeWidgetViewModel.DisplaySet {
        WMFReadingChallengeWidgetViewModel.DisplaySet(
            ...
            subtitle: family == .systemSmall
                ? String.localizedStringWithFormat(WMFLocalizedString("reading-challenge-streak-no-days", value: "%1$d of 25", comment: "Streak pill shown on the reading challenge widget, %1$d is the number of days completed out of 25."), streak)
                : String.localizedStringWithFormat(WMFLocalizedString("reading-challenge-streak-of-days", value: "{{PLURAL:%1$d|%1$d of 25 day|%1$d of 25 days}}", comment: "Streak pill label shown on the reading challenge widget. %1$d is the number of days completed out of 25."), streak),
            icon: nil,
    ...
    static func enrolledNotStartedSet(family: WidgetFamily) -> WMFReadingChallengeWidgetViewModel.DisplaySet {
        ...
        let defaultTitlesAndImage: (String, String, String) = (
            WMFLocalizedString("reading-challenge-enrolled-not-started-title-ready", value: "Ready, set, read!", comment: "Title shown on the reading challenge widget when enrolled but not yet started."),
            WMFLocalizedString("reading-challenge-enrolled-not-started-subtitle-towards", value: "Start working towards a 25-day streak!", comment: "Subtitle shown on the reading challenge widget when enrolled but not yet started."),
            "readingGlobe"
        )
        ...
        let titlesAndImages: [(String, String, String)] = [
            ...
            (
                WMFLocalizedString("reading-challenge-enrolled-not-started-title-start", value: "Start your reading challenge.", comment: "Title shown on the reading challenge widget when enrolled but not yet started."),
                WMFLocalizedString("reading-challenge-enrolled-not-started-subtitle-somewhere", value: "Every streak starts somewhere.", comment: "Subtitle shown on the reading challenge widget when enrolled but not yet started."),
                "standingGlobe"
            ),
            (
                WMFLocalizedString("reading-challenge-enrolled-not-started-title-spin", value: "Spin up a new streak?", comment: "Title shown on the reading challenge widget when enrolled but not yet started."),
                WMFLocalizedString("reading-challenge-enrolled-not-started-subtitle-article", value: "Read one article to get started.", comment: "Subtitle shown on the reading challenge widget when enrolled but not yet started."),
                "synthGlobe1"
            ),
            (
                WMFLocalizedString("reading-challenge-enrolled-not-started-title-fresh", value: "A fresh start.", comment: "Title shown on the reading challenge widget when enrolled but not yet started."),
                WMFLocalizedString("reading-challenge-enrolled-not-started-subtitle-away", value: "Your streak is just one article away.", comment: "Subtitle shown on the reading challenge widget when enrolled but not yet started."),
                "synthGlobe2"
            )
        ]
        ...
        return WMFReadingChallengeWidgetViewModel.DisplaySet(
            ...
            button2Title: family == .systemSmall ? nil : CommonStrings.randomButton,
            button1URL: family == .systemSmall
                ? URL(string: "wikipedia://explore?source=widget_reading_challenge")
                : URL(string: "wikipedia://search?source=widget_reading_challenge"),
...
struct ReadingChallengeWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName(WMFLocalizedString("reading-challenge-widget-display-name", value: "Random article", comment: "Display name for the reading challenge widget shown in the widget picker, which now is a random article picker while dormant."))
