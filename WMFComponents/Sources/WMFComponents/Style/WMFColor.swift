...
public enum WMFColor {
    ...
    public static let green600alpha = UIColor(0x00AF89, alpha: 0.2)
    ...
    public static let orange100 = UIColor(0xF8F1E34D)
    public static let orange100alpha = UIColor(0xFF9500, alpha: 0.05)
